...
Phase 54 adds a static browser runtime for deterministic Knoema demos. The runtime is a small TypeScript-source module copied into `demo/knoema-core.js` by the build script. It does not require Pyodide, Python, or an LLM API key.
