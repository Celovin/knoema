...
I believe the paper fits cs.MA as a multi-agent systems and agent-based modeling infrastructure contribution, with cs.AI as a secondary category because the runtime can optionally use LLM-backed decision generation.

If you are open to reviewing the submission for endorsement fit, I can send the PDF, source bundle, and repository link. I have left the submission itself for the account owner to complete manually.
