"""Discord bot entry point for Knoema."""
...
from knoema_bots.core import format_discord_embed, parse_bot_command, run_scenario_for_bot
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run the Knoema Discord bot.")
    ...
    @bot.command(name="knoema")  # type: ignore[untyped-decorator]
    async def knoema_command(ctx: Any, *parts: str) -> None:
        embed_payload = build_embed_for_command(" ".join(("knoema", *parts)))
