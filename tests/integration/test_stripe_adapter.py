...
from knoema.billing.stripe_adapter import StripeUsageAdapter


@pytest.mark.slow
def test_stripe_usage_record_round_trip_when_enabled() -> None:
    if os.environ.get("KNOEMA_ENABLE_STRIPE_TEST") != "1":
        pytest.skip("set KNOEMA_ENABLE_STRIPE_TEST=1 for live Stripe test-mode verification")
