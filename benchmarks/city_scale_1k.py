"""Run the deterministic 1K-agent city-scale benchmark."""
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=Path("tmp/city_scale"))
    parser.add_argument("--backend", choices=["single", "multiprocessing", "ray"], default="multiprocessing")
    ...
    for repetition in range(1, args.repetitions + 1):
        ...
        result.write_jsonl(args.output / f"run_{repetition:02d}.jsonl")
    ...
    summary = _summary_payload(args, run_summaries, hashes)
