"""Run the deterministic 10K-agent city-scale benchmark on a 60x60 grid."""
...
REPORT_PATH = Path("benchmarks/city_scale_10k_report.md")


def main() -> None:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--output", type=Path, default=Path("tmp/city_scale_10k"))
    ...
    parser.add_argument("--grid-width", type=int, default=60)
