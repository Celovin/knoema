...
| `source` | string | yes | Source system, default `knoema`. |

Example:

```json
{"actor_id":"demo-user","category":"prompt_injection","event_id":"evt-001","outcome":"blocked","reason":"blocked by deterministic content filter","source":"knoema","timestamp":"2026-04-19T00:00:00+00:00"}
```
