...
> These documents are drafts. Review with qualified counsel before publishing, signing, billing, or relying on them with customers.
...
- [Privacy Policy v1 English](legal/privacy_policy_v1_en.md)
- [Data Processing Agreement Template](legal/dpa_template.md)
- [Attribution Manifest](legal/attribution.md)
- [SLA Template v1 English](legal/sla_template_v1_en.md)
- [Security Posture v1 English](legal/security_posture_v1_en.md)
- [Refund and Cancellation Policy v1 Korean](legal/refund_cancellation_policy_v1_ko.md)
