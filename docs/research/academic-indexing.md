...
Phase 31 prepared Luvoire for archival citation and research indexing. Phase 50 adds the arXiv v2 and Papers with Code packet. Phase 62 promoted the repository metadata to `v0.2.0`; v7 starts the Luvoire `v0.3.0` rename line. The repository now carries machine-readable citation metadata, Zenodo metadata, the final local paper source, a generated PDF preview, and a structured Papers with Code submission packet. External account steps still need to be completed by the project owner.
...
- Latest archived DOI: `10.5281/zenodo.19645166` (v0.2.0)
- Earlier version DOI: `10.5281/zenodo.19643410` (v0.1.1)
- License: MIT, encoded for Zenodo as `mit`
- Repository: `https://github.com/Celovin/luvoire`
- Related paper source: `https://github.com/Celovin/luvoire/blob/main/paper/main.tex`
...
2. Enable GitHub integration for `Celovin/luvoire`.
3. Import or archive the `v0.3.0` release after it is tagged; `v0.1.1` (`19643410`) and `v0.2.0` (`19645166`) are already archived under the shared concept record (`19643409`).
...
- Paper title: `Luvoire: An Open Runtime for Persistent NPCs, Synthetic Replay Research, and Reproducible Agent Simulation`
- Abstract source: `paper/abstract.tex`
- Code repository: `https://github.com/Celovin/luvoire`
- Framework: Python
- License: MIT
- Primary tasks:
  - Multi-agent RL
...
```text
Luvoire is an open runtime for persistent social agents. It exposes memory, relationships, emotion, environment state, deterministic logs, scenario DSLs, and game SDK adapters so agent behavior can be inspected and reproduced outside a model prompt.
```
...
| v0.3.0 DOI | Pending after release archive |
