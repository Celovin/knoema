...
SCENARIO_KO_LABELS: dict[str, str] = {
    ...
    "Tech demo day": "기술 데모 데이",
    "Wedding after-party": "결혼식 뒤풀이",
    "Funeral wake": "장례식장 조문",
    "Prison yard (fictional)": "교도소 운동장 (가상)",
    "Zoom team standup": "줌 팀 스탠드업 회의",
    "Kindergarten storytime": "유치원 이야기 시간",
    "Senior center chess": "노인복지관 체스 모임",
    "Concert lobby intermission": "콘서트 로비 휴식 시간",
}
